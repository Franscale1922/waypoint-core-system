      ...
      <header className="sticky top-0 z-50 glass border-b border-[#e2ddd2]/60">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-6 md:gap-8">
            ...
            <Link
              href="/book"
              className="text-xs font-semibold tracking-wide uppercase text-[#0c1929] bg-[#C8622E] hover:bg-[#D4724A] px-5 py-2.5 rounded-lg transition-all press-effect"
            >
              Book a Call
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-[10px] font-semibold uppercase tracking-wider text-[#0c1929] bg-[#C8622E] hover:bg-[#D4724A] px-2 py-0.5 rounded transition-colors"
                >
                  Text me
                </a>
              </div>
          ...
          <div className="border-t border-white/5 mt-10 sm:mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-5">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/kelsey-stuart-014b7b50/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#555] hover:text-[#C8622E] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/franchise_match_maker/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#555] hover:text-[#C8622E] transition-colors">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/kelsey.stuart.94" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[#555] hover:text-[#C8622E] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* X / Twitter */}
              <a href="https://x.com/__Waypoint" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-[#555] hover:text-[#C8622E] transition-colors">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@Waypoint-Franchise" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-[#555] hover:text-[#C8622E] transition-colors">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@waypoint007" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#555] hover:text-[#C8622E] transition-colors">
