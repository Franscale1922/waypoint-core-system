...
export const metadata: Metadata = {
  ...
  description:
    "Two free tools for working out where you stand before talking to anyone. The readiness quiz scores your situation, and the archetype quiz finds your fit.",
  ...
  openGraph: {
    ...
    images: [{ url: "/og/og-tools.png", width: 1200, height: 630, alt: "Free Franchise Tools: Quizzes, Checklists, Resources | Waypoint" }],
  },
};
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="bg-white border border-[#e8e0d0] rounded-xl p-8 sm:p-10 flex flex-col">
            <div className="mb-6">
              ...
              <div className="space-y-3 mb-8">
                ...
                {[
                  ...
                  "Whether your goals, including income, autonomy, and lifestyle, are a fit for this path",
            ...
            <div className="mt-auto pt-6">
              <Link
                href="/scorecard"
                className="inline-flex items-center justify-center w-full px-7 py-4 text-sm font-semibold tracking-wide text-[#0c1929] bg-[#CC6535] hover:bg-[#D4724A] rounded-lg transition-all min-h-[48px]"
              >
      ...
      <section className="border-t border-[#e8e0d0] bg-[#f0ede8] py-14 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/book"
              className="inline-flex items-center justify-center px-7 py-4 text-sm font-semibold tracking-wide text-[#0c1929] bg-[#CC6535] hover:bg-[#D4724A] rounded-lg transition-all min-h-[48px]"
            >
              Book a Free Call
            </Link>
            <a
