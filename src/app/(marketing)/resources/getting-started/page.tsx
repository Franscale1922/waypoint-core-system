    ...
    <main className="bg-[#FAF8F4] text-[#0c1929]">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-10 border-t border-[#e8e0d0] pt-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <p className="text-xs font-medium text-[#CC6535] uppercase tracking-[0.2em]">Once You Have the Basics</p>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/archetype" className="group block bg-[#f5ebd1] border border-[#e8d8b0] rounded-lg p-5 hover:shadow-md hover:border-[#CC6535]/60 transition-all">
          ...
          <Link href="/faq" className="group block bg-white border border-[#e8e0d0] rounded-lg p-5 hover:shadow-md hover:border-[#CC6535]/40 transition-all">
