    ...
    <main className="bg-[#FAF8F4] text-[#0c1929]">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-10 border-t border-[#e8e0d0] pt-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <p className="text-xs font-medium text-[#C8622E] uppercase tracking-[0.2em]">Useful Alongside These Articles</p>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link href="/franchise-consultant-vs-broker" className="group block bg-white border border-[#e8e0d0] rounded-lg p-5 hover:shadow-md hover:border-[#C8622E]/40 transition-all">
          ...
          <Link href="/resources/industry-spotlights" className="group block bg-white border border-[#e8e0d0] rounded-lg p-5 hover:shadow-md hover:border-[#C8622E]/40 transition-all">
