    ...
    <main className="bg-[#FAF8F4] text-[#0c1929]">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-16 sm:pt-24 pb-10">
        ...
        <div className="flex items-center gap-4 text-xs text-[#7a7a7a]">
          ...
          {/* Attribute and text now come from the same validated value, so they
              cannot disagree. Previously dateTime carried the raw string while
              the text was whatever new Date() normalized it to, and an unusable
              value printed the literal words "Invalid Date" to visitors. */}
