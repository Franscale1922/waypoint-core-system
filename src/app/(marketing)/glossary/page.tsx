  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        definition:
          "The moment when your franchise's total revenue equals its total costs — both the initial investment and ongoing operating expenses. Before break-even, you are spending more than you are earning and relying on working capital reserves to stay afloat. Time to break even varies widely: low-cost service franchises may hit it in 3 to 6 months, while restaurant build-outs can take 18 to 24 months or longer. During validation calls, ask existing franchisees how long it took them to break even — this is often more telling than any projection in Item 19.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        term: "Ghost Kitchen",
        definition:
          "A delivery-only food operation with no dining room, no storefront, and no walk-up service — just a commercial kitchen optimized for preparing meals sold through delivery apps. Several established franchise brands now offer ghost kitchen models with dramatically lower build-out costs, sometimes one-tenth of a traditional restaurant location. The tradeoff is that you lose walk-in customers entirely and become dependent on third-party delivery platforms and their commission fees. Ghost kitchens represent one of the fastest-growing entry points into food-service franchising.",
        related: "/resources/asset-light-vs-capital-heavy-choosing-your-franchise-type",
        relatedLabel: "Asset-light vs. capital-heavy: choosing your type",
      },
      {
      ...
      <section className="pt-20 sm:pt-28 pb-12 sm:pb-16 px-6 border-b border-[#e8e0d0]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-[#4a4a3e] leading-relaxed max-w-xl">
            Every term you will encounter when evaluating a franchise — FDD items, royalty, territory, discovery day, ROBS, unit economics, non-compete clauses, and more — defined in plain language without jargon. 90+ entries. Last updated: March 2026.
          </p>
        </div>
      </section>
