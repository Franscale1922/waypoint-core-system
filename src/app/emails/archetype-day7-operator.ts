/**
 * Archetype Email 4 (Day 7): Soft discovery-call invite for The Operator
 * Sent ~7 days after archetype quiz completion
 * Tag: archetype-email-4
 */

export function archetypeDay7OperatorHtml(name: string, unsubscribeUrl: string): string {
...
<head>
  ...
  <title>One last note, Operator</title>
</head>
<body style="margin:0;padding:0;background:#FAF8F4;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <p style="margin:0 0 16px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      A week ago you took the archetype quiz and landed on Operator. I sent you a couple of follow-ups, and I want to keep my word on what I said in the first one. This is the last email unless you reach out.
    </p>

    <p style="margin:0 0 16px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      The thing about Operators is that you are the archetype most likely to be on time, organized, and reading the FDD line by line before our first conversation. You do not need motivational content. You need someone who can stress-test the operating spine of a brand alongside you and tell you whether the model holds up to the kind of execution you would actually bring to it.
    </p>

    <p style="margin:0 0 24px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      What a call with me actually is: thirty minutes where I tell you where the gaps are between what a brand markets and what it actually delivers operationally. I have sat on both sides of the table long enough to know which questions cut through it. If the answer is none of your current short list is worth it, that is a useful answer too. I have given it before.
    </p>
    ...
    <div style="background:#0c1929;border-radius:12px;padding:24px 28px;margin:32px 0;">
      <p style="margin:0 0 8px;font-size:20px;color:#FFFFFF;line-height:1.4;">
        &ldquo;Operators do not need me to tell them how to run a business. They need me to tell them which businesses are worth their operating discipline.&rdquo;
      </p>
...
export function archetypeDay7OperatorText(name: string, unsubscribeUrl: string): string {
  const firstName = name.split(" ")[0];
  return `
${firstName},
...
What a call with me actually is: thirty minutes where I tell you where the gaps are between what a brand markets and what it actually delivers operationally. I have sat on both sides of the table long enough to know which questions cut through it.

"Operators do not need me to tell them how to run a business. They need me to tell them which businesses are worth their operating discipline."
