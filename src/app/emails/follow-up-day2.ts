...
<body style="margin:0;padding:0;background:#FAF8F4;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <!-- Question 1 -->
    <div style="border-left:3px solid #d4a55a;padding-left:20px;margin:28px 0;">
      <p style="margin:0 0 8px;font-size:14px;font-weight:700;font-family:Arial,sans-serif;color:#c08b3e;letter-spacing:0.1em;text-transform:uppercase;">01</p>
    ...
    <!-- Question 2 -->
    <div style="border-left:3px solid #d4a55a;padding-left:20px;margin:28px 0;">
      <p style="margin:0 0 8px;font-size:14px;font-weight:700;font-family:Arial,sans-serif;color:#c08b3e;letter-spacing:0.1em;text-transform:uppercase;">02</p>
    ...
    <!-- Question 3 -->
    <div style="border-left:3px solid #d4a55a;padding-left:20px;margin:28px 0;">
      <p style="margin:0 0 8px;font-size:14px;font-weight:700;font-family:Arial,sans-serif;color:#c08b3e;letter-spacing:0.1em;text-transform:uppercase;">03</p>
