/**
 * Archetype Email 4 (Day 7): Soft discovery-call invite for The Educator
 * Sent ~7 days after archetype quiz completion
 * Tag: archetype-email-4
 */

export function archetypeDay7EducatorHtml(name: string, unsubscribeUrl: string): string {
...
<head>
  ...
  <title>One last note, Educator</title>
</head>
<body style="margin:0;padding:0;background:#FAF8F4;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <p style="margin:0 0 16px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      A week ago you took the archetype quiz and landed on Educator. I sent you a couple of follow-ups, and I want to keep my word on what I said in the first one. This is the last email unless you reach out.
    </p>

    <p style="margin:0 0 16px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      The thing I keep coming back to with Educators is that the franchise decision is rarely the hard part. The hard part is sitting still long enough to choose. Your instinct is to keep learning until the picture is complete. The picture is never complete. I have not met a single owner who looked back and said the timing was perfect.
    </p>

    <p style="margin:0 0 24px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      What a call with me actually is: thirty minutes where I tell you, based on what you have shared and what you have not, which categories are worth real evaluation and which ones are not. If the answer is none of them, that is a useful answer too. I have given that answer before.
    </p>
    ...
    <p style="margin:0 0 28px;font-size:16px;color:#4a4a4a;line-height:1.7;">
      If the timing is not right yet, bookmark the link and come back when it is. There is no pressure on my end and no scarcity to manufacture. The categories I care about you matching with will still be there.
    </p>
...
export function archetypeDay7EducatorText(name: string, unsubscribeUrl: string): string {
  const firstName = name.split(" ")[0];
  return `
${firstName},
...
"The Educators who hire me are not looking for permission. They are looking for the second opinion that lets them stop researching and start choosing."

If the timing is not right yet, bookmark the link and come back when it is. There is no pressure on my end and no scarcity to manufacture.
