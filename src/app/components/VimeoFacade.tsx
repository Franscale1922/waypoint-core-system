    ...
    >
      {playing ? (
        ...
        <>
          ...
          >
            {/* Gold play circle */}
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#d4a55a] group-hover:bg-[#e2be80] flex items-center justify-center shadow-lg transition-all duration-200 group-hover:scale-110">
              <svg
