      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Divide the system's total annual sales by the number of units open for the full period. Franchisors usually publish it in Item 19 of the FDD. Read the footnotes closely, because some brands report only their top-performing units or exclude locations open less than a year, which raises the figure.",
          },
          {
