  ...
  <table className="w-full text-sm border-collapse">
    ...
    <tbody>
      ...
      <tr className="border-b border-[#e8e0d0]">
        ...
        <td className="py-3 px-4 text-[#5a5a4a]">Extensive franchisee performance history</td>
