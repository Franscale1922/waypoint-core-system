...
faqs:
  ...
  - q: "What should you ask a franchisor about financial performance?"
    a: "Ask whether the franchisor discloses financial performance data for existing units in the franchise disclosure document, and how it is broken down. Some disclose detailed figures; many disclose little or nothing. Whatever they provide, validate it by speaking with current franchisees directly about what the business generates and what it costs to run at different stages. A franchise advisor can help you build a realistic model from comparable operators in the system."
  - q: "What is debt service on an SBA franchise loan and how does it affect the math?"
    a: "Debt service is the total monthly principal and interest payment on your loan. On a $250,000 SBA loan at rates comparable to those as of 2026, monthly debt service runs approximately $3,300 per month, roughly $40,000 per year, which is a real operating cost you carry before you pay yourself. A franchise that looks affordable on the sticker price can look very different once debt service is in the model, which is why it belongs in your cost math from the start."
  - q: "How does adding franchise units change the return on your time?"
    a: "Adding a second or third unit using cash flow from the first creates growth that does not require a proportional increase in your hours. Management infrastructure, marketing spend, and vendor relationships are shared across units. An owner who has built a small multi-unit operation and stepped back to part-time involvement is getting a very different return on their time than one still working full-time in a single unit years in. The model creates that leverage; your strategy about how many units and how fast determines whether you reach it."
escapeKit: true
---
When people evaluate franchise investments, they usually focus on the upfront number. What does it cost to get in? How long until it ramps? They treat it like a savings account: put money in, money comes back.
